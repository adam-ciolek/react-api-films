		...
		<div>
			<div className="container mx-auto min-h-screen mt-32">
				...
				<div className="mt-20  sm:w-96 mx-auto rounded p-6 bg-gradient-to-r from-sky-three via-sky-two to-sky bg-sky shadow-2xl shadow-sky ">
					<div>
						<h2 className="text-center font-bold capitalize text-2xl">
							register
						</h2>
						<form className="mt-4">
							...
							<div className=" flex flex-col my-4">
								<label htmlFor="reapetPassword" className="mb-2">
									Repeat Password
								</label>
								<input
									type="password"
						...
						<h4 className="text-sm w-full text-right mt-6">
							Back to{" "}
							<span>
								<a href="/sign-in" className="text-teal-500 font-bold">
									Login
								</a>
							</span>
						</h4>
